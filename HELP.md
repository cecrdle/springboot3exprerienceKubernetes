...
* [Getting Started with Distributed Tracing](https://docs.spring.io/spring-boot/docs/3.2.0-M3/reference/html/actuator.html#actuator.micrometer-tracing.getting-started)
...
* [Prometheus](https://docs.spring.io/spring-boot/docs/3.2.0-M3/reference/htmlsingle/index.html#actuator.metrics.export.prometheus)
...
```
$ docker run --rm -p 8080:8080 testapp:0.0.1-SNAPSHOT
```
